...
const Header = () => {
  ...
  <div className="container mx-auto flex cursor-pointer flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <Link to ='/cart' className="inline-flex items-center bg-gray-100 border-0 py-1 px-3  focus:outline-none hover:bg-indigo-200 rounded text-base mt-4 md:mt-0">Go to cart
