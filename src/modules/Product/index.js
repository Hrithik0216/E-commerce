...
const Product = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            ...
            console.log(data)
            setProduct(data) //setProduct function is called
        }
        fetchProduct()
            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className='flex'>
                            <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:-translate-y-1 hover:scale-110 hover:bg-purple-600 transition ease-in-out delay-150 rounded mr-2" onClick={() => { handleCart(product,true)}}>Buy it now</button>
                            <button className="flex ml-auto border border-indigo-500  py-2 px-6 focus:outline-none hover:-translate-y-1 hover:scale-110 hover:bg-purple-600 transition ease-in-out delay-150 hover:ease-in hover:text-white rounded" onClick={() => { handleCart(product) }}>Add to cart</button>
                        </div>
